...
import { DialogajouterComponent } from './dialogajouter.component';
...
describe('DialogajouterComponent', () => {
  let component: DialogajouterComponent;
  let fixture: ComponentFixture<DialogajouterComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations:[DialogajouterComponent],
    ...
    fixture = TestBed.createComponent(DialogajouterComponent);
